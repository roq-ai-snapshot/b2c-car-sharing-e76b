...
import { getLocationById } from 'apiSdk/locations';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('location', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/locations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Latitude" text={data?.latitude} />

                <FormListItem label="Longitude" text={data?.longitude} />
