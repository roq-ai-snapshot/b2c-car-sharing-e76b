...
-- AddForeignKey
ALTER TABLE "location" ADD CONSTRAINT "location_car_id_fkey" FOREIGN KEY ("car_id") REFERENCES "car"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
